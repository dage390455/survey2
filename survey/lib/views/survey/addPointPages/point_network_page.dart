...
class PointNewWorkPage extends StatefulWidget {
  PointNewWorkPage({Key key, this.title}) : super(key: key);


  final String title;

  @override
  _PointNewWorkPageState createState() => _PointNewWorkPageState();
}

class _PointNewWorkPageState extends State<PointNewWorkPage> {
