...
class SurvayElectricalFireCreatePage extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<SurvayElectricalFireCreatePage> {
...
//           mainAxisAlignment: MainAxisAlignment.start,
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: editPurpose1, //写入方法名称就可以了，但是是无参的
            child: Container(
              alignment: Alignment.center,
              height: 60,
              child: new Row(
...
//        scrollDirection: Axis.vertical,
        ...
        children: <Widget>[
          ...
          new Padding(
            ...
            child: Text(
              "至少拍摄1张环境照片，可以清楚的看到电箱周围的墙面情况和离地高度。",
              style: new TextStyle(fontSize: prefix0.fontsSize),
            ),
          ),
        ],
