...
class EditElectricalDangerousPage extends StatefulWidget {
  var name = "";

  EditElectricalDangerousPage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditElectricalDangerousPage> {
  var historyKey = "histroyEditElectricalDangerousPagekey";
  var name = "";
