...
class EditContentPage extends StatefulWidget {
  ...
  var historyKey = "";
  var hintText = "";
  EditContentPage({this.name,this.title,this.historyKey,this.hintText});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditContentPage> {
           ...
           child: GestureDetector(
             onTap: () {
               ...
               if (this.name.length > 0) {
                 SaveDataManger.addHistory(this.name, widget.historyKey);
