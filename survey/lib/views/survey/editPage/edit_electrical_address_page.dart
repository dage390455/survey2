...
class EditElectricalAdressPage extends StatefulWidget {
  var name = "";

  EditElectricalAdressPage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditElectricalAdressPage> {
  var historyKey = "histroyEditElectricalAdressPagekey";
  var name = "";
...
//                  labelText: '备注',
              hintText: '请输入详情的电箱位置。例如：望京soho T3 B座 2808 东侧内墙',
            ),
            autofocus: false,
            onChanged: (val) {
              name = val;
