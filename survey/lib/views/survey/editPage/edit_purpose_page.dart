...
class EditPurposePage extends StatefulWidget {
  var name = "";

  EditPurposePage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditPurposePage> {
  var historyKey = "histroyEditPurposePageKey";
  var name = "";
