...
class EditElectricalPurposePage extends StatefulWidget {
  var name = "";

  EditElectricalPurposePage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditElectricalPurposePage> {
  var historyKey = "histroyEditElectricalPurposePagekey";
  var name = "";
...
//                  labelText: '备注',
              hintText: '请输入电箱级别。例如：总电箱/分电箱/末端电箱/设备电箱。',
            ),
            autofocus: false,
            onChanged: (val) {
              name = val;
