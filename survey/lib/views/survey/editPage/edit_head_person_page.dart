...
class EditHeadPersonPage extends StatefulWidget {
  var name = "";

  EditHeadPersonPage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditHeadPersonPage> {
  var historyKey = "histroyEditHeadPersonPageKey";
  var name = "";
