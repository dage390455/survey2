...
class EditProjectNamePage extends StatefulWidget {
  var name = "";

  EditProjectNamePage({this.name});
  @override
  _State createState() => _State(name: this.name);
}

class _State extends State<EditProjectNamePage> {
  var historyKey = "histroySurveysiteProjectname";
  var name = "";
